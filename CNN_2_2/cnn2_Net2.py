...
cnn = create_model(nc1=120, ksize=3, act1="relu", mpsize=3, drop1=0.1, hn=64, h_act="relu", drop2=0.1)
...
modelhist.to_csv("cnn2_NET2_history.csv", index=False)

# save model
cnn.save("cnn2_NET2.h5")
